...
// console.log('----Dop 1----');
// document.write('<br>----Dop 1----<br>');
// let num1d = +prompt('num1');
// let num2d = +prompt('num2');
// let num3d = +prompt('num3');
// if (num1d <= num2d && num1d <= num3d) {
//     document.write('<br>' + num1d);
//     if (num2d <= num3d) {
//         document.write('<br>' + num2d);
//         document.write('<br>' + num3d);
//     } else {
//         document.write('<br>' + num3d);
//         document.write('<br>' + num2d);
//     }
// } else if (num2d <= num1d && num2d <= num3d) {
//     document.write('<br>' + num2d);
//     if (num1d <= num3d) {
//         document.write('<br>' + num1d);
//         document.write('<br>' + num3d);
...
//         document.write('<br>' + num1d);
//     }
// } else if (num3d <= num1d && num3d <= num2d) {
//     document.write('<br>' + num3d);
//     if (num1d <= num2d) {
//         document.write('<br>' + num1d);
//         document.write('<br>' + num2d);
...
// console.log('----Dop 2----');
// document.write('<br>----Dop 2----<br>');
// let sign = prompt('color?', 'green');
// if (sign === 'green') {
//     alert('GO');
// }else if (sign === 'yellow'){
//     alert('WAIT');
...
// Если светофор в аварийном режиме вывести "делай что хочешь"!
console.log('----Dop 3----');
document.write('<br>----Dop 3----<br>');
const sign3 = prompt('Цвет?', 'зеленый');
const cars = confirm('Есть машины?');
if (sign3 === 'зеленый' && !cars) {
    alert('иди');
} else if (sign3 === 'зеленый' && cars) {
    alert('подожди пока нарушители проедут');
} else if (sign3 === 'желтый') {
    if (cars) {
        alert('жди');
    }else {
        alert('все рано жди');
    }
} else if (sign3 === 'красный') {
   if (!cars) {
        alert('стой все рано');
    }else {
        alert('стой и жди');
