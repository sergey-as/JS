...
task(2, 'Є масив котрий характеризує правила. Створити скрипт...');
// {
//     let rules = [
//         {
...
task('Додатково 1', 'за допомогою fetch (як в прикладі) отримати від jsonplaceholder всі users...');
...
//                 }
//
//                 let users = createElem('div', document.body, '');
//                 users.id = 'users';
...
task('Додатково 2', 'за допомогою fetch (як в прикладі) отримати від jsonplaceholder всі posts...');
...
function outputData(objs, parentId) {
    let parentBlock = createElem(document.body, 'div', '');
...
// За допомогою document.createElement вивести їх в браузер.
// Помістити кожен окремий об'єкт в блок, при цьому кожен внутрішній об'єкт(якщо він існує) в свій блок (блок в блоці).
task('Додатково 3', 'за допомогою fetch (як в прикладі) отримати від jsonplaceholder всі comments...');
// func("https://jsonplaceholder.typicode.com/", 'comments');
...
task('Додатково! 4', 'при помощи fetch (как в примере) получить от jsonplaceholder все posts....');
func4("https://jsonplaceholder.typicode.com/", 'posts');
        ...
        .then(objsJsonplaceholder1 => {
                ...
                fetch(baseURL + suffOfBaseURL2)
                    ...
                    .then(objsJsonplaceholder2 => {
                            ...
                            let objs2 = JSON.parse(jsonObjs2);


                            outputData(objs1, suffOfBaseURL2);
                        }
                    );

                // outputData(objs, suffOfBaseURL1);
            }
        );
};
